...
6.  **Convergence:** This process is repeated until the change in the cost function between iterations drops below a small threshold ($\epsilon = 1e^{-3}$) or a maximum number of **iterations** (3,000) is reached. This **automatic convergence check** ensures effective training without unnecessary computations.
...
<p align="center">
  <img src="results/cost_history.png" alt="Cost History" width="500"><br>
  <em>Fig. 1: Cost Function Convergence</em>
</p>

<p align="center">
  <img src="results/train_performance.png" alt="Train Performance" width="500"><br>
  <em>Fig. 2: Training Set Performance</em>
</p>

<p align="center">
  <img src="results/test_performance.png" alt="Test Performance" width="500"><br>
  <em>Fig. 3: Test Set Performance</em>
</p>
